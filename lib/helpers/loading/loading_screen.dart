...
import 'package:mobile_motivation/helpers/loading/loading_screen_controller.dart';
...
class LoadingScreen {
  ...
  void show({
    ...
    // Updates loading screen text if it was not closed.
    if (controller?.update(text) ?? false) {
      return;
    } else {
      // Initialize the loading screen controller if it is null.
